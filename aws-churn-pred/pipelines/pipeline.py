...
def get_pipeline(
    ...
    # had transform_instances=["ml.m5.large"], but my free account doesn't include any Transform instances
    ...
    # step_transform, was before step_clarify
    step_cond = ConditionStep(
        name="CheckAUCScoreChurnEvaluation",
        conditions=[cond_lte],
        if_steps=[step_register, step_create_model, step_config_file, step_clarify], 
        else_steps=[],
    )
